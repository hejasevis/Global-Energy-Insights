...
if len(df_test) < future_years:
    ...
    st.markdown("You are now forecasting energy trends based solely on historical production by energy type. Use the comparison and RMSE metrics to assess model reliability.")
